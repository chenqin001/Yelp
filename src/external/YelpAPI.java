...
public class YelpAPI{
	...
	private static final String API_KEY = "BjK1c8KSs4EnO6qsKow51XqJmJZabt40mCQcUvzE61l9u0oOp8wL1GTR_ZeLU3fRZnRHoh9SYMO_M5pq9j0yKaA4yyX_OTo_2Yp-PH0cULiNmVoLBdbQxddMquGuW3Yx";
	...
	public List<Item> search(double lat, double lon, String term) {
    	if (term == null || term.isEmpty()) {
 		...
 		try {
			term = URLEncoder.encode(term, "UTF-8"); // Zoe Chen => Zoe20%Chen
